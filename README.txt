...
1. You need to install FFmpeg. -> https://www.ffmpeg.org/download.html#build-windows
  ...
  and paste the files (ffmpeg.exe,ffplay.exe,ffprobe.exe) where the 'EasyDownload.exe' is located.

2. pip command installing.
...
3. Install packages.
 ...
 If you have any issue run 'yt-dlp -U' in cmd.
                                     ...
                                     [ CHANGELOG ]
2.0.0 - Added Facebook download, Search download.
